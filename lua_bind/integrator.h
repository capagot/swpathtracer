#ifndef LUA_BIND_INTEGRATOR_H
#define LUA_BIND_INTEGRATOR_H
...
struct Integrator {
    ...
    long int prescribed_min_intersection_tests_count_;
    long int prescribed_max_intersection_tests_count_;
    PathTerminationCriterion path_termination_criterion_;
    int path_length_;
};
}  // namespace lb

#endif  // LUA_BIND_INTEGRATOR_H
